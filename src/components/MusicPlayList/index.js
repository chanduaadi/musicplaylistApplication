...
class MusicPlayList extends Component {
  ...
  onDeleteList = id => {
    ...
    const onDeleteFilteredData = initialData.filter(
      eachItem => eachItem.id !== id,
    )

    this.setState({initialData: onDeleteFilteredData})
  }

  getFilteredData = () => {
    const {searchValue, initialData} = this.state

    const searchedData = initialData.filter(eachItem =>
  ...
  render() {
    ...
    return (
      <div className="page-bg-container">
        ...
        <div className="page-btm-container">
          <div className="input-search-container">
            <h1 className="song-playlist-text">Songs Playlist</h1>
